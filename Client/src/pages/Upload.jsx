        ...
        <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center px-4">
          <div className="bg-gray-800 rounded-xl p-6 text-center max-w-sm w-full">
            <p className="text-white text-lg font-semibold">
              ⚠️ You must be logged in to upload a book.
            </p>
            <p
              onClick={() => navigate("/signin")}
              className="mt-4 text-blue-400 hover:text-blue-500 cursor-pointer font-medium"
            >
              Sign in to your account
            </p>
            <p className="mt-2 text-gray-400 text-sm">Redirecting to home...</p>
          </div>
        </div>
      )}
