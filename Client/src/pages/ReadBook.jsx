...
const ReadBook = () => {
  ...
  return (
    <div>
      ...
      {showshareoption && (
        <div className="absolute m-5 sm:right-[20%] sm:top-[22%] z-50 bg-gray-300 border border-gray-200 rounded-lg shadow-xl p-4 w-72 transition-all ease-in-out duration-300 delay-75">
          {/* URL + Copy Button */}
